...
*Distribution of standardized sums (10,000 batches of 10,000 draws each) against the Gaussian $\mathcal{N}(0,1)$ overlay. Left ($\alpha = 2.5$): the CLT works, the histogram closely matches the bell curve. Center ($\alpha = 1.5$): the sums are heavily right-skewed with extreme kurtosis (217), far from Gaussian. Right ($\alpha = 0.5$): the distribution collapses into a spike with a massively long tail, excess kurtosis of 5,133. The Gaussian overlay is invisible because the scales are incomparable.*
...
| US wildfire sizes | Malamud et al. (2005) | 1.30 to 1.81 | Infinite variance |
| Cyber risk (identity losses) | Maillart & Sornette (2010) | 0.7 | **Infinite mean** |
| Cyber risk (by sector) | Zeller & Cybenko (2023) | 0.1 to 0.3 | **Infinite mean** |
...
A process is ergodic when its time average equals its ensemble average: when the experience of one entity over many periods matches the average across many entities in one period. For well-behaved distributions ($\alpha > 2$), this holds. The law of large numbers ensures that your company's cumulative loss experience converges to the population expectation, and the [volatility drag](volatility-drag-vs-premium-drag.md) penalty $\sigma^2/2$ is a finite, manageable cost.

In the infinite-variance regime ($1 < \alpha \leq 2$), the mean still converges and an "actuarially fair" premium can be computed. But the variance that governs volatility drag does not converge. Under multiplicative growth dynamics, the time-average growth rate includes a $-\sigma^2/2$ penalty. When $\sigma^2$ is infinite, that penalty is infinite. The loss process looks ergodic in expectation, but the *growth* process is not: without mitigation, the time-average growth rate is negative infinity, meaning **certain ruin on a long enough horizon**. The fair premium exists, but the variance around any individual company's experience is unbounded, and the insurance that tames that variance is what restores ergodic growth.

When $\alpha \leq 1$, even this partial ergodicity collapses. The sample mean no longer converges to any finite value. It is dominated by the single largest observation, and every additional extreme draw can reset it by orders of magnitude. The ensemble average, the bedrock of actuarial pricing, doesn't exist as a finite quantity. An "actuarially fair" premium cannot be computed because there is no finite expected loss to base it on.
...
2. Carroll, S. J., Hensler, D., Gross, J., Sloss, E. M., Schonlau, M., Abrahamse, A., & Ashwood, J. S. (2005). [Asbestos and the future of mass torts.](https://www.nber.org/papers/w10308) *Journal of Economic Perspectives*, 19(4), 183-210.
...
7. Institute for Legal Reform. (2024). [Nuclear verdicts: An update on trends, causes, and solutions.](https://instituteforlegalreform.com/wp-content/uploads/2024/05/ILR-May-2024-Nuclear-Verdicts-Study.pdf)

8. Li, S., & Banerjee, T. (2021). [Spatial and temporal pattern of wildfires in California from 2000 to 2019.](https://www.nature.com/articles/s41598-021-88131-9) *Scientific Reports*, 11, 8628.

9. Maillart, T., & Sornette, D. (2010). [Heavy-tailed distribution of cyber-risks.](https://link.springer.com/article/10.1140/epjb/e2010-00120-8) *European Physical Journal B*, 75, 357-364.

10. Malamud, B. D., Morein, G., & Turcotte, D. L. (2005). [Characterizing wildfire regimes in the United States.](https://www.pnas.org/doi/10.1073/pnas.0500880102) *Proceedings of the National Academy of Sciences*, 102(13), 4694-4699.

11. McNeil, A. J. (1997). [Estimating the tails of loss severity distributions using extreme value theory.](https://www.cambridge.org/core/journals/astin-bulletin-journal-of-the-iaa/article/estimating-the-tails-of-loss-severity-distributions-using-extreme-value-theory/745048C645338C953C522CB29C7D0FF9) *ASTIN Bulletin*, 27(1), 117-137.

12. Moscadelli, M. (2004). [The modelling of operational risk: Experience with the analysis of the data collected by the Basel Committee.](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=557214) Bank of Italy Working Paper No. 517.

13. Munich Re. (2025). [Wildfires around Los Angeles, severe thunderstorms: US natural catastrophes dominate global losses in the first half of 2025.](https://www.munichre.com/en/company/media-relations/media-information-and-corporate-news/media-information/2025/natural-disaster-figures-first-half-2025.html)
...
16. Zeller, G., & Cybenko, G. (2023). [Cyber loss model risk translates to premium mispricing and risk sensitivity.](https://pmc.ncbi.nlm.nih.gov/articles/PMC10024527/) *Geneva Papers on Risk and Insurance -- Issues and Practice*, 48, 372-406.
